...
export default function Entrepreneurship() {
  ...
  useEffect(() => {
    try {
      ...
      // Set current user immediately with all required fields
      setCurrentUser({
        rollNumber: user.rollNumber || 'N/A',
        fullName: user.fullName || 'N/A',
        fatherName: user.fatherName || 'N/A',
        programName: user.programName || 'N/A',
        section: user.section || 'N/A',
        universityId: user.universityId || 'N/A',
        department: user.department || 'N/A',
        batch: user.batch || 'N/A',
        currentSemester: user.currentSemester || 'N/A'
      });
    ...
    const examResult = savedResults.find(result =>
      result.examId === '4' && result.user?.rollNumber === user.rollNumber
    );
  ...
  const handleSubmit = () => {
    ...
    const result = {
      examId: '4', // Fixed exam ID for Entrepreneurship
    ...
    const filteredResults = savedResults.filter(r => 
      !(r.examId === '4' && r.user?.rollNumber === currentUser.rollNumber)
    );
      ...
      <div className="quiz-container" style={{
        ...
        <div className="quiz-body" style={{
          ...
          <div className="section-header" style={{
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Name:</b> &nbsp; {currentUser?.fullName || 'N/A'}</div>
          <div className="section-header" style={{
            backgroundColor: '#00678b',
            color: 'white',
            padding: '10px',
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Father Name:</b> &nbsp; {currentUser?.fatherName || 'N/A'}</div>
          <div className="section-header" style={{
            backgroundColor: '#00678b',
            color: 'white',
            padding: '10px',
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Roll No:</b> &nbsp; {currentUser?.rollNumber || 'N/A'}</div>
          <div className="section-header" style={{
            backgroundColor: '#00678b',
            color: 'white',
            padding: '10px',
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Program:</b> &nbsp; {currentUser?.programName || 'N/A'}</div>
          <div className="section-header" style={{
            backgroundColor: '#00678b',
            color: 'white',
            padding: '10px',
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Section:</b> &nbsp; {currentUser?.section || 'N/A'}</div>
          <div className="section-header" style={{
            backgroundColor: '#00678b',
            color: 'white',
            padding: '10px',
            ...
            boxSizing: 'border-box',
            fontWeight: 'bold'
          }}><b>Course:</b> &nbsp; Entrepreneurship</div>
