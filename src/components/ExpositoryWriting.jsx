...
export default function ExpositoryWriting() {
  ...
  const handleSubmit = () => {
    ...
    const result = {
      examId: '3', // Fixed exam ID for Expository Writing
      examTitle: 'Expository Writing',
    ...
    const filteredResults = savedResults.filter(r => 
      !(r.examId === '3' && r.user?.rollNumber === currentUser.rollNumber)
    );
          ...
          <>
            ...
            <div className="quiz-body" style={{
              ...
              <div className="section-header" style={{
                ...
                boxSizing: 'border-box',
                fontWeight: 'bold'
              }}><b>Course:</b> Expository Writing</div>
